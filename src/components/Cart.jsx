...
const Cart = () => {
  ...
  return (
    <>
      ...
      >
        <div
          className={`blur-eefect-theme h-screen max-w-xl w-full absolute right-0`}
        >
          <CartCount totalQTY={totalQTY}
          onCartToggle={onCartToggle} onClearCartItems={onClearCartItems}/>
          ...
          {cartItems?.length === 0 ? 
           ...
           : 
            <div>
              <div
                className="flex items-start justify-start flex-col gap-y-7 lg:gap-y-5 overflow-y-scroll h-[81vh]
            scroll-smooth scroll-hidden py-3"
              ...
              <div className="bottom-0 bg-white w-full px-5 py-2 grid items-center">
